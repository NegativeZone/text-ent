...
def split_data_into_scores():
    ...
    with open("snli_1.0_dev.txt","r") as data:
        ...
        scores = []
        for row in train:
            hyp_sentences.append(np.vstack(sentence2sequence(row["sentence1"].lower())[0]))
            evi_sentences.append(np.vstack(sentence2sequence(row["sentence2"].lower())[0]))
...
evidences = ["The quick brown fox jumps over the lazy dog."]

hypotheses = ["Two animals were involved in the situation."]
